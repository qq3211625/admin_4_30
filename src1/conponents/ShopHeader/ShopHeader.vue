<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupports=true">
      <div class="discounts-left">
        <div class="activity activity-green">
          ...
          <span class="activity" :class="supportClasses[info.supports[0].type]">{{info.supports[0].content}}</span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="isShowSupports" @click="isShowSupports=false">
